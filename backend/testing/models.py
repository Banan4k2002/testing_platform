...
class TestPerson(models.Model):
    ...
    result_person = models.FloatField(
        'Результат тестирования попытка 1', null=True, blank=True
    )
    amount_time = models.FloatField('Среднее время', null=True, blank=True)
    ...
    log_test = models.CharField(
        'Логин для теста', max_length=15, null=True, blank=True
    )
    passw_test = models.CharField(max_length=15, null=True, blank=True)
    is_passed = models.PositiveSmallIntegerField(
        'Кол-во удачных прохождений теста', null=True, default=0, blank=True
    )
    n_try = models.PositiveSmallIntegerField(
        'Кол-во попыток', null=True, blank=True
    )
    use_try = models.PositiveSmallIntegerField(
        'Кол-во использованых попыток', null=True, blank=True
    )
    phone = models.CharField(
        'Номер телефона', max_length=63, null=True, default='0', blank=True
    )
    time_str = models.CharField(
        'Время тестирования попытка 1', max_length=31, null=True, blank=True
    )
    time_str2 = models.CharField(
        'Время тестирования попытка 2', max_length=31, null=True, blank=True
    )
    result_person2 = models.FloatField(
        'Результат тестирования попытка 2', null=True, blank=True
    )
    n_break_quest = models.IntegerField(null=True, blank=True)
...
class Test(models.Model):
    ...
    f_check = models.BooleanField('Правильный ли ответ', null=True, blank=True)
    f_answer = models.BooleanField('Ответ тестируемого', default=False)
    n_try = models.PositiveSmallIntegerField('Номер попытки')
    n_q = models.IntegerField('Номер вопроса в тесте', null=True, blank=True)
...
class Answer(models.Model):
    ...
    answer_cod = models.CharField(
        'Номер варианта ответа', max_length=50, null=True, blank=True
    )
    f_check = models.BooleanField('Правильный ли ответ', null=True, blank=True)
...
class Group(models.Model):
    ...
    parent_id = models.IntegerField('Группа вопросов', null=True, blank=True)
    ...
    img = models.ImageField(
        'Изображение', upload_to='images/', null=True, blank=True
    )
...
class NameSprav(models.Model):
    ...
    item_name_cod = models.CharField(
        'Кол-во вопросов в тесте', max_length=255, null=True, blank=True
    )
    is_change = models.BooleanField(default=False, null=True, blank=True)
